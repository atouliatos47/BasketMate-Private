// ===================================================
// app.js — Core: init, splash, household, push (Fixed Version)
// ===================================================
const App = {
    wakeLock: null,
    ...
    init() {
        ...
        if (hasHousehold) {
            ...
            if (!hasLanguage) {
                ...
                API.connectSSE();
                API.startKeepAlive();
                setTimeout(() => this.setupPushNotifications(), 6000); // Safer delay
            }
        } else {
            setTimeout(() => this.showLanguageFirst(), 2200);
        }
    ...
    startApp() {
        ...
        API.connectSSE();
        API.startKeepAlive();
        setTimeout(() => this.setupPushNotifications(), 6000); // Safe delay
    },
    ...
    async setupPushNotifications() {
        ...
        // Extra delay to make sure household is saved in Neon
        ...
        try {
            ...
            if (!response.ok) {
                console.warn('Push subscribe returned non-OK status');
                return;
            }
